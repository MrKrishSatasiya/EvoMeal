...
import {
    L as K
} from "./loading-inline.m-3ITsi1.js";
...
function z2(d, l) {
    ...
    var t = U(),
        m = n(t);
    I(m, () => l.children), f(t), O("submit", t, r), c(d, t), S()
}
var W = A('<span class="loading svelte-11o9glk"><!></span>'),
    X = A('<p class="submit svelte-11o9glk"><button type="submit"><!> <!></button></p>');
...
function g2(d, l) {
    ...
    var r = X(),
        t = n(r);
    N(t, `${G??""} svelte-11o9glk`);
    var m = n(t); {
        var v = a => {
                var i = L(),
                    h = E(i);
                I(h, () => l.children), c(a, i)
            },
            u = a => {
                var i = w("Submit");
                c(a, i)
    ...
    f(t), f(r), g(() => t.disabled = s(e) !== null), c(d, r), S()
}
var Z = A("At most <b> </b>", 1),
    $ = A("At least <b> </b>", 1),
    a2 = A('<li class="svelte-eq6gf0"><!> <!> </li>');

function E2(d, l) {
    D(l, !0);
    let e = _(() => l.plan.swole_user.preset_diet === o.KETO),
        r = _(() => [
            ["carbs", s(e) ? "Net Carbs" : "Carbs"],
            ["fats", "Fat"],
            ["proteins", "Protein"]
        ]);
    var t = L(),
        ...
        var h = z(i, 2); {
            var P = M => {
                    var F = Z(),
                        C = z(E(F)),
                        x = n(C);
                    g(() => b(x, `${B(l.nutrition[`max_${p()}`])??""}g`)), f(C), c(M, F)
                },
                R = M => {
                    var F = $(),
                        C = z(E(F)),
                        x = n(C);
                    g(() => b(x, `${B(l.nutrition[`min_${p()}`])??""}g`)), f(C), c(M, F)
                };
            y(h, M => {
                s(e) && p() === "carbs" ? M(P) : M(R, !1)
            })
        }
        var V = z(h);
        f(a), g(() => b(V, ` ${k()??""}`)), c(v, a)
...
export {
    k2 as D, z2 as F, E2 as M, g2 as S
};
//# sourceMappingURL=index.CDCF3V9p.js.map